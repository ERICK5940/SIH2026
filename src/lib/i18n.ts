...
export const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "FIELD INTELLIGENCE • INCIDENT REPORTS": "FIELD INTELLIGENCE • INCIDENT REPORTS",
    "ALERT CENTER": "ALERT CENTER",
    "VEHICLE TRACKING — LIVE": "VEHICLE TRACKING — LIVE",
    "AFFECTED VEHICLES": "AFFECTED VEHICLES",
    "ACCEPTED VEHICLES": "ACCEPTED VEHICLES",
    "IMPACT ANALYSIS • TURF BUFFER 80KM": "IMPACT ANALYSIS • TURF BUFFER 80KM",
  ...
  hi: {
    ...
    "FIELD INTELLIGENCE • INCIDENT REPORTS": "फील्ड इंटेलिजेंस • घटना रिपोर्ट",
    "ALERT CENTER": "अलर्ट केंद्र",
    "VEHICLE TRACKING — LIVE": "वाहन ट्रैकिंग — लाइव",
    "AFFECTED VEHICLES": "प्रभावित वाहन",
    "ACCEPTED VEHICLES": "स्वीकृत वाहन",
    "IMPACT ANALYSIS • TURF BUFFER 80KM": "प्रभाव विश्लेषण • 80 किमी बफर",
  ...
  as: {
    ...
    "FIELD INTELLIGENCE • INCIDENT REPORTS": "ফিল্ড ইনটেলিজেন্স • ঘটনা প্রতিবেদন",
    "ALERT CENTER": "এলাৰ্ট কেন্দ্ৰ",
    "VEHICLE TRACKING — LIVE": "বাহন ট্রেকিং — লাইভ",
    "AFFECTED VEHICLES": "প্ৰভাৱিত বাহন",
    "ACCEPTED VEHICLES": "গ্ৰহণ কৰা বাহন",
    "IMPACT ANALYSIS • TURF BUFFER 80KM": "প্ৰভাৱ বিশ্লেষণ • 80 কিমি বাফাৰ",
